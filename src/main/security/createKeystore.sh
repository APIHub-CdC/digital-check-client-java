#!/bin/sh
export PRIVATE_KEY_FILE=/Users/fmgaliciap/Cdc/certificados-apihub/pri_key.pem
export CERTIFICATE_FILE=/Users/fmgaliciap/Cdc/certificados-apihub/certificate.pem
export SUBJECT=/C=MX/ST=MX/L=MX/O=CDC/CN=CDC
export PKCS12_FILE=/Users/fmgaliciap/Cdc/certificados-apihub/keypair.p12
export KEYSTORE_PASSWORD=prueba
export KEY_PASSWORD=prueba
export KEYSTORE_FILE=/Users/fmgaliciap/Cdc/certificados-apihub/keystore.jks
export ALIAS=cdc
