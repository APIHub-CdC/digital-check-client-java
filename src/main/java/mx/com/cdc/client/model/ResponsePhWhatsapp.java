...
@ApiModel(description = "Detalle del número telefónico con alguna cuenta existente de whatsapp.")


public class ResponsePhWhatsapp {
  ...
  public ResponsePhWhatsapp registered(Boolean registered) {
  ...
  public ResponsePhWhatsapp lastSeen(Integer lastSeen) {
    this.lastSeen = lastSeen;
    return this;
  }
   
  @ApiModelProperty(example = "1659560211", value = "Timestamp de la última actividad en línea, en formato UNIX y zona horaria UTC.")
  ...
  public ResponsePhWhatsapp photo(String photo) {
    this.photo = photo;
    return this;
  }
  ...
  public ResponsePhWhatsapp about(String about) {
    this.about = about;
    return this;
  }
   
  @ApiModelProperty(example = "No dejes que tus miedos se apoderen de tus sueños, lucha por lo que quieres.", value = "Descripción del perfil.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResponsePhWhatsapp responsePhWhatsapp = (ResponsePhWhatsapp) o;
    return Objects.equals(this.registered, responsePhWhatsapp.registered) &&
        Objects.equals(this.lastSeen, responsePhWhatsapp.lastSeen) &&
        Objects.equals(this.photo, responsePhWhatsapp.photo) &&
        Objects.equals(this.about, responsePhWhatsapp.about);
  }
  @Override
  public int hashCode() {
    return Objects.hash(registered, lastSeen, photo, about);
  }
  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResponsePhWhatsapp {\n");
